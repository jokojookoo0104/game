...
void Witch::InitSpite() {
	...
	sprite->insert(pair<ENEMY_STATE, Sprite*>(ENEMY_STATE::FOLLOW,
		new Sprite(TEXTURE->Get(ID_TEXTURE_MAP_1_ENEMY), PATH_TEXTURE_MAP_1_ENEMY_WITCH_FOLLOW, 2, 0.09f)));
	sprite->insert(pair<ENEMY_STATE, Sprite*>(ENEMY_STATE::ATK,
		new Sprite(TEXTURE->Get(ID_TEXTURE_MAP_1_ENEMY), PATH_TEXTURE_MAP_1_ENEMY_WITCH_ATK, 2, 0.09f)));
