...
void GameRun(HWND hWnd, int dt)
{
	if (d3ddv->BeginScene()) 
	{
		// Clear back buffer with BLACK
		d3ddv->ColorFill(back_buffer,NULL,D3DCOLOR_XRGB(50,50,50));
		...
		rect.right = x + 20;
		rect.bottom = y + 20;
		if (rect.right < SCREEN_WIDTH && rect.top == 0)
		{
			x += 20;
		}
		...
		if (rect.bottom == SCREEN_HEIGHT && rect.left > 0 ) {
